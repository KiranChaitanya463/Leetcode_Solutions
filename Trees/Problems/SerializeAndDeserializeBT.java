...
// so basically the task is to implement two methods one serialize the binary tree into a string
// and to implement a deserialize that string to the original binary tree
// we are using the level order traversal and build a string with commas
// and at the deserialize we create the binary tree with that using queue.
